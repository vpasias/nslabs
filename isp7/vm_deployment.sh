...
ssh -o "StrictHostKeyChecking=no" ubuntu@netsim "curl -O https://releases.hashicorp.com/vagrant/2.2.14/vagrant_2.2.14_x86_64.deb && sudo apt install -y ./vagrant_2.2.14_x86_64.deb --allow-downgrades"
...
ssh -o "StrictHostKeyChecking=no" ubuntu@netsim "ansible-galaxy collection install git+https://github.com/nokia/ansible-networking-collections.git#/grpc/ && sudo python3.8 -m pip install grpcio protobuf"
ssh -o "StrictHostKeyChecking=no" ubuntu@netsim "ansible-galaxy collection install git+https://github.com/nokia/ansible-networking-collections.git#/grpc/ && sudo python3.9 -m pip install grpcio protobuf"
ssh -o "StrictHostKeyChecking=no" ubuntu@netsim "sudo python3.8 -m pip install google-cloud && sudo python3.8 -m pip install google-cloud-vision"
ssh -o "StrictHostKeyChecking=no" ubuntu@netsim "sudo python3.9 -m pip install google-cloud && sudo python3.9 -m pip install google-cloud-vision"
